#!/usr/bin/env node
// Runs as a `prebuild` step. Refreshes src/staff-prompt.txt from the live
// hfu/layers-martin STAFF_PROMPT.md so the static build shows an up-to-date
// Staff prompt on the fallback landing page, without a runtime fetch.
// Ported verbatim from hfu/faceless-cartographer (DECISIONS.md D19); see
// this repo's DECISIONS.md D1 for the lineage note. On failure, leaves the
