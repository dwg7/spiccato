...
// including base-style.json which is itself vendored there from
// hfu/kitavolca -- see that repo's DECISIONS.md D24). Style construction is
// unaffected by spiccato's URL-state-first departure -- see this repo's
// DECISIONS.md D1.
