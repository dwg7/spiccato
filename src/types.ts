...
//
// Vendored verbatim from hfu/faceless-cartographer (2nd gen, commit a016206)
// -- this module is environment-independent and carries no opinion about
// URL state, so nothing about spiccato's URL-state-first departure (see
// DECISIONS.md D2) required a rewrite here. See DECISIONS.md D1 for the
// lineage note.
